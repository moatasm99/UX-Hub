...
const LearningHub = () => {
    ...
    const categories = ['All', ...new Set(courseCatalog.map(c => c.category))];
                        ...
                        <div className="flex flex-wrap items-center gap-4">
                            ...
                            <div className="flex flex-wrap gap-2">
                                {categories.map(cat => (
                                    ...
                                    >
                                        {cat === 'All' ? 'All Categories' : `${categoryMeta[cat]?.icon || ''} ${cat}`}
                                    </button>
                                ))}
                            </div>
                                                ...
                                                {expandedCards[course.id] && (
                                                    <div className="mt-4 space-y-3 animate-in slide-in-from-top-2 duration-200">
                                                        ...
                                                        {course.resources.map((res, idx) => (
                                                            ...
                                                            >
                                                                <div className={`p-2 rounded-lg ${res.type === 'Video'
                                                        ...
                                                        {course.books.length > 0 && (
                                                            <div className={`pt-3 border-t ${theme === 'dark' ? 'border-slate-700' : 'border-slate-200'}`}>
                                                                <p className={`text-xs font-medium mb-2 ${theme === 'dark' ? 'text-slate-500' : 'text-slate-400'}`}>
                                                                    📚 Recommended Reading
                                                                </p>
